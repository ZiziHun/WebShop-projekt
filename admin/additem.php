            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <form action="upload.php" method="post">
                        ...
                        <small>Használhatod a következő formázásokat: <b>[b]</b>félkövér szöveg<b>[/b]</b>, <i>[i]</i>dőlt szöveg<i>[/i]</i>, <u>[u]</u>aláhúzott szöveg<u>[/u]</u>, <code>[code]</code>kód<code>[/code]</code>.</small>
                        <textarea id="description" name="description" placeholder="Termék leírása" rows="5" cols="30" required style="resize: vertical; width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-family: Arial, sans-serif;"></textarea><br><br>
